...
// Current Pins
#define CURR_L 16
#define CURR_L_VOLT_OFFSET 428
#define CURR_R 17
#define CURR_R_VOLT_OFFSET 428
...
Current_Sensor current_sensorL(CURR_L, CURR_L_VOLT_OFFSET);
Current_Sensor current_sensorR(CURR_R, CURR_R_VOLT_OFFSET);
