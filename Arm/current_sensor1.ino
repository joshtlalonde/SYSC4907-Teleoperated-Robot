/*  SparkFun ACS712 and ACS723 Demo
    ...
    Set for current sensor 1
*/
#define AnalogPin 2

const int analogInPin = AnalogPin;
...
float sensitivity = 155.0 / 150.0; //155mA per 150mV 
...
void loop() {
  ...
  float voltage = 0.402 * sensorValue -428; // 428 is offset to get to approx. 1500mV (Gain??)
